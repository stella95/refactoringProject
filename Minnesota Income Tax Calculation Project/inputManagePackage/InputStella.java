...
import dataManagePackage.DatabaseStella;
import dataManagePackage.Taxpayer;
import dataManagePackage.Receipt.Receipt;
import dataManagePackage.Receipt.ReceiptFactory;

public class InputStella {
	
	private ReceiptFactory receiptFactory;
	private static InputStella inputInstance = null;
	...
	private DatabaseStella databaseStella = DatabaseStella.getInstance();
	...
	public void addTaxpayersDataFromFilesIntoDatabase(String afmInfoFilesFolderPath, List<String> taxpayersAfmInfoFiles){
		for (String afmInfoFile : taxpayersAfmInfoFiles)
		{
			...
			databaseStella.addTaxpayerToList(newTaxpayer);
		}
	}
